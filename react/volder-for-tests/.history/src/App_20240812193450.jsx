...
// Выносим reducer из компонента, т.к. он от него не зависит
// Переделка самодельной функции dispatch(которая закоментирована ниже) используя функциюю reduser
...
function App() {
    ...
    const dispatch = (action) => {
        const newState = reducer(dataForContext, action);

        setDataForContext(newState);
    };
