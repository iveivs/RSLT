...
// декларативный, мы тут получаем текущий год и клад(помоему тут всё будет декларативным, в этом помоему и есть один из принципов подхода в реакте, могу конечно ошибаться)
