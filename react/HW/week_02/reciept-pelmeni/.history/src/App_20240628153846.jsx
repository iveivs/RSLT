			...
			<div className={styles.card}>
				...
				<div className={styles.steps}>
					...
					<ul className={styles['steps-list']}>
						{steps.map((obj) => (
							// <li key={obj.id} className={styles['steps-item'] + ' ' + styles.done + ' ' + styles.active}>
							<li key={obj.id} className={styles['steps-item'] + (activeIndex   === Number(obj.id.slice(2)) ? ' ' + styles.active : ' ' + styles.done)}>
					...
					<div className={styles['buttons-container']}>
						<button onClick={clickToBack} className={styles.button}>Назад</button>
						<button onClick={clickToForvard} className={styles.button}>
							Далее
