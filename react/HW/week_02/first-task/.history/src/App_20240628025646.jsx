			...
			<div className={styles.app}>
				...
				<div className={styles['list-container']}>
					...
					<ul className={styles.list}>
						{list.length > 0 ? list.map((obj) => <li className={styles['list-item']} key={obj.id}> {obj.value} {localDate}</li>) : <p className={styles['no-margin-text']}>Нет добавленных элементов</p>}
					</ul>
				</div>
			</div>
		</>
