        ...
        <>
            <div className={classes.container}>
                <div className={classes.display}>
                    ...
                    <span className={showYellowText ? classes.spanYellow : null}>
                        {/* {!currentAnswer ? `${operand1} ${operator} ${operand2}` : currentAnswer } */}
                        {operand1 ? operand1 : null}
                        {operator ? operator : null}
                        {operand2 ? operand2 : null}
                        {/* {operand2 + operator + operand1} */}
                ...
                >
                    {NUMS.map((btn) => (
                        <button
                            ...
                            key={btn}
                            onClick={()=> {operator ?  setOperand2(prev=> prev + btn) : setOperand1(prev=> prev + btn)}}
                        >
                            {btn}
                        </button>
                    ))}
                ...
                <div className={classes.clearAndEqualBtn}>
                    ...
                    <button
                        ...
                        onClick={() => { setOperand1(""), setOperand2(""), setOperator(""), setCurrentAnswer(''),  setShowYellowText(false);}}
                    >
                        С
                    </button>
                    <br />
