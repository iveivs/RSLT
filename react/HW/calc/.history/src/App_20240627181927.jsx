    ...
    return (
        <>
            <div className={classes.container}>
                <div className={classes.display}><span className={showYellowText ? null : classes.spanYellow}>{dispNum}</span></div>
                <div
                ...
                <button className={classes.clear} onClick={clearDisplay}>С</button>
                <br />
                </div>
