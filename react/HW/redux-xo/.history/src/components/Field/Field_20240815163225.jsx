...
const Field = () => {
	...
	const handleClick = (e) => {
		...
		console.log('Click Field', store.getState().field);
		if (!store.getState().fieldfield.includes('') && !isGameEnded) {
			console.log('IS DRUW');
			store.dispatch({ type: 'SET_IS_DRAW', payload: true }); // добавил из useEf
		} 
	};
