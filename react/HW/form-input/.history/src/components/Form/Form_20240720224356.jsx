...
// ПРОВЕРКА ПАРОЛЯ
    const validatePasword = ({ target }) => {
        ...
        if (!/^[\w_]*$/.test(target.value)) {
            ...
            setIsAllInputsValid([...isAllInputsValid, true])
            return
        } 
    ...
    const onBlurEmail = (e) => {
        ...
        validateEmail(e)
        console.log('isAllInputsValid Email', isAllInputsValid);
    };

    const onBlurPassword = (e) => {
        validatePasword(e)
        console.log('isAllInputsValid Pass 1', isAllInputsValid);
    }
    ...
    console.log('Proverka isAllInputsValid', isAllInputsValid.every((el)=> el === true));
    ...
    return (
        <>
            ...
            <form onSubmit={onSubmit}>
                ...
                <button type="submit" disabled={true}>Зарегестрироваться</button>
            </form>
        </>
    );
};
