...
class FieldContainer extends Component {
    ...
    const dispatch = useDispatch() currentPlayer = useSelector(selectCurrentPlayer) isGameEnded = useSelector(selectIsGameEnded) isDraw = useSelector(selectIsDraw) field = useSelector(selectField)
