...
const InformationLayout = ({isDraw, currentPlayer, isGameEnded, setCurrentPlayer}) => {
	return (
		<>
			<div className={styles.info_container}>
				{isDraw && <p>Ничья</p>}
				{!isDraw && isGameEnded && <p className={styles.win}>`Победа: {currentPlayer  === 'X' ? setCurrentPlayer('O') : setCurrentPlayer('X')}`</p>}
