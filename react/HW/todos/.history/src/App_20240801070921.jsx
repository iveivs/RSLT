...
function App() {
	...
	// console.log('newTodos typeof', typeof newTodos);
	let result = newTodos.toSorted((a, b) => a.task.localeCompare(b.task))
			...
			<div className={styles.container_app}>
				...
				<div className={styles.task_list}>
					<div className={styles.checkbox_container}>
						<span className={styles.span_checkboxText}>Сортировать по алфавиту</span><input className={styles.sort_checkbox} checked={isChecked} onChange={handleCheckboxChange} type="checkbox" />
					</div>
					{isLoading ? (
