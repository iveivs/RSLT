...
После этого в методе `handleInput()` выведите t`his.isValid в консоль. Убедитесь, что при вводе в поле ввода корректных значений выводитится true, а при неправильных — false. 
