...
Шаг 1. В файле index.js раскомментируйте импорт компонента App и строчку, добавляющую компонент на страницу. Демонстрационный пример (DemoCounter) можете либо закомментировать, либо удалить. 
