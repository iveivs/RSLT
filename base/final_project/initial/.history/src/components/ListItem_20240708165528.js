...
export class ListItem extends Component {
  setup(props) {
    ...
    console.log('ToTaL from LIST ITEM comp', this.state.total); // проверка пропсов (здесь нормальный ТЕКУЩИЙ стейт Тотал )
  ...
  handleDelete(event){
    ...
    console.log('полученный amount из атрибута, curAmount', curAmount);
