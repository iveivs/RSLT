...
export class Form extends Component {
  setup(props) {
    ...
    this.this.$rootElement.addEventListener('click', this.handleSubmit.bind(this))
  }
  ...
  handleInput(event) {
    ...
    this.isValid ? this.$button.removeAttribute('disabled', '') : this.$button.setAttribute('disabled', '')
  }
