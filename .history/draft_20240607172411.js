class Dictionary {
    ...
    add(word, description) {
        ...
        if(!this.#words.hasOwnProperty(word)) this.#words[word] = this._addNewWord(word, newWord)
        // this.#words.hasOwnProperty(word) ? this.#words = this.#words : 
    }
    remove(keyForRemove) {
    ...
    _addNewWord(wordKey, wordObj) {
        this{ ['word']: wordKey, ['description']: wordObj.description }
    }
}
