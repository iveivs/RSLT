...
const getDaysBeforeBirthday = (nextBirthdayDate) => {
    console.log('nextBirthdayDate: ',typeof nextBirthdayDate, nextBirthdayDate);

    let birthDayDate = new Date(nextBirthdayDate)
    console.log('birthDayDate: ',typeof birthDayDate, birthDayDate);

    birthDayDate = nextBirthdayDate.getTime()getTime
    console.log('birthDayDate 2: ',typeof birthDayDate, birthDayDate);
    const currentDate = Date.now()
    let dayToBirthday = nextBirthdayDate.getTime() - currentDate

    console.log('dayToBirthday: ', dayToBirthday);
