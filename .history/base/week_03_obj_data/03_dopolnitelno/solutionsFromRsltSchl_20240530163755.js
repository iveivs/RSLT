...
с учетом скидок (discount, указаны в процентах) и с учетом указанных клиентом количеством продуктов. Итоговое значение должно быть округлено до сотых. Это можно сделать с помощью метода toFixed().
const groceries = {
    "73Wakv": {
        name: "Orange Juice",
        price: 1.5,
