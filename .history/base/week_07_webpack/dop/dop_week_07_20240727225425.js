...
Функция будет принимать 1 параметр postId и с помощью данного URL: «https://jsonplaceholder.typicode.com/posts/1» получать данные о посте (в URL выше id поста равен 1).
