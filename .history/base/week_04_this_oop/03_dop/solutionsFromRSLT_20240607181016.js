...
Подсказка: для того чтобы извлечь из строки “8:00” значение часов, вы можете использовать split(':'), получить первый элемент из полученного массива и преобразовать его к числу.