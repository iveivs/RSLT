...
function makeDomestic(isDomestic) {
    console.log(`type: ${this.type}, name: ${this.name}, isDomestic: ${isDomestic}, makeSound: ${this.makeSound} `);
    return { type: this.type, name: ${this.name}, isDomestic: ${isDomestic}, makeSound: ${this.makeSound}  }
}
