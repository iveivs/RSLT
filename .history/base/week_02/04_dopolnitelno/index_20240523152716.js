...
let indexOfMinGoals = getIndexOfMinimalGoals(goals)
console.log(`Самые нерезультативные матчи были под номерами ${numberOfMinGoals}. В каждом из них было забито по ${indexOfMinGoals} мячу(а)`);