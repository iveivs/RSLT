...
// 1
console.log(Number(' 1 2 3 4 5')); // думал он пробелы сам срежет и выдаст(например как он срезает лишнии нули)  и выдаст 12345, второй вариант был NaN
// 2
console.log(Number('1234 5'));// думал так же как и написал выше, т.к. разницы между примерами особой нету
// 3
