...
const questionsAndAnswers2 = [
    {question: 'JavaScript появился в 1995 году?', answer: '1996', flag},
    {question: 'Спецификация JavaScript называется ECMAScript?', answer: ''},
    {question: 'JavaScript был создан за 1 месяц?', answer: '10 дней'},   
]

questionsAndAnswers2.forEach(elem => {
    let currentAnswer = confirm(elem.question)
    currentAnswer ? alert('Верно') : alert(`Не верно, правильный ответ ${elem.answer}`)
})
